...
namespace KenshiMultiplayer.Networking.Inventory
{
    public class InventoryItem
    {
        ...
        public InventoryItem SplitStack(int splitQuantity)
        {
            ...
            InventoryItem newItem = new InventoryItem
            {
                ...
                BluntProtection = BluntProtection,
                CutProtection = CutProtection,
                PierceProtection = PierceProtection,
                Nutrition = Nutrition,
                Hydration = Hydration,
                ...
                IsBuildingMaterial = IsBuildingMaterial
            };
        ...
        public bool MergeStack(InventoryItem other)
        {
            ...
            if (other.ItemName != ItemName || other.ItemType != ItemType)
                return false;
